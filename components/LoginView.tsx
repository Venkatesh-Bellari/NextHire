...
import { signIn, signInWithGithub } from '../services/firebaseService';
            ...
            <div className="flex min-h-screen flex-col justify-center items-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="mt-10 text-center text-sm text-slate-400">
                        Not a member?{' '}
                        <button onClick={() => onNavigate('signup')} className="font-semibold leading-6 text-indigo-400 hover:text-indigo-300">
                            Create an account
                        </button>
                    </p>
                </div>
